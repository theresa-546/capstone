...
function LemonBasil() {
  ...
  let sliderArr = [<img id='plant-top-pic' src='images/lemon basil.jpeg' alt=''/>, <video src='images/lemon basil vid.mp4' width="100%" height="300" controls="controls" autoplay="false" />];
