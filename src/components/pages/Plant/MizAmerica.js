...
function MizAmerica() {
  ...
  let sliderArr = [<img id='plant-top-pic' src='images/miz america mizuna.jpg' alt=''/>, <img src='images/miz america mizuna size.jpg' alt=''/>, <video src='images/miz america mizuna vid.mp4' width="100%" height="300" controls="controls" autoplay="false" />];
